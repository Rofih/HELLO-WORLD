...
public class MensturationApp{
	...
	public static void information(){
		...
		System.out.println("Your next menstral flow is"+ calculateFlow(lastFlowDate,menstralCycle) );

		System.out.print("Do you want to know your likely ovulation period?,if YES enter 1 then if NO enter 0");
		int answer3 = input.nextInt();
		if(answer3==1){
			System.out.println("Your ovulation is likely on the" + calculateOvulation(lastFlowDate));
		
		}
		System.out.print("Do you want to know your likely safe periods?,if YES enter 1 then if NO enter 0");
		int answer4 = input.nextInt();
		if(answer4==1){
			System.out.print("Your safe period will likely range from "+ calculateSafeDaysBeginning(lastFlowDate)+"to"+ calculateSafeDaysEnding(lastFlowDate));
		}
