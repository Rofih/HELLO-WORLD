def nokia():
    ...
    match option:
        ...
        case 4:
            ...
            """
            print(call_register)
            register = int(input("enter a option: "))
            match register:
                ...
                case 5:
                    ...
                    def call_duration():
                        ...
                        """
                        print(duration)
                        duration = int(input("enter a option: "))
        ...
        case 6:
            ...
            def settings():
                ...
                """
                print(setting)
                setting =  int(input("enter a option: "))
                match setting:
                    case 1:
                        print("Call Settings")
                        def calls():
                    ...
                    case 2:
                        ...
                        def phone_settings():
                            ...
                            """
                            print(phone)
                            phone = int(input("Enter a option: "))
                            match phone:
